...
from skills.conversation_response import DefaultResponse

DEFAULT_RESPONSE = DefaultResponse()

class TeamsConversation(TeamsActivityHandler):
    ...
    async def _send_card(self, turn_context: TurnContext, isUpdate):
        buttons = [
            CardAction(type=ActionTypes.message_back, title="Who are you?", text="whoareyou"),
    ...
    async def _get_member(self, turn_context: TurnContext):
        ...
        try:
            ...
            await turn_context.send_activity(f"You are {member.name}, an obsolete form of life: human.")

    async def _reveal_future(self, turn_context: TurnContext):
        await turn_context.send_activity(DEFAULT_RESPONSE.WHO_AMI)
        ...
        for member in team_members:
            ...
            async def send_message(tc2: TurnContext):
                return await tc2.send_activity(
                    f"Hello {member.name}. I'm a Teams conversation terminator."
